...
function Information() {
  return (
    <div className='mb-16 m-2'>
	   ...
	   <h2 className='font-serif text-3xl font-bold'>overall statistics</h2>
	   <p className='font-serif text-sm dark:text-gray-400 mt-1'>Explore my specialty</p>
	   </div>
     	<div className=" container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">200+</p>
				<p>Class</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">7 500+</p>
				<p>Total student</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">14</p>
				<p>certification</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">24/7 h</p>
				<p>Support</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">99,9 %</p>
				<p>Uptime</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg bg-purple-600 text-gray-100">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-1xl font-semibold">90%</p>
				<p>success</p>
			</div>
		</div>
	</div>
